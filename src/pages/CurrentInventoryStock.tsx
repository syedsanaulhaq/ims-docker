...
const CurrentInventoryStock: React.FC = () => {
  ...
  const fetchInventoryData = async () => {
    try {
      ...
      const response = await fetch(`/api/inventory/current-stock?${params.toString()}`);
  ...
  const fetchSummary = async () => {
    try {
      const response = await fetch('/api/inventory/current-stock/summary');
  ...
  const fetchItemHistory = async (itemId: string) => {
    try {
      const response = await fetch(`/api/inventory/current-stock/${itemId}/history`);
