...
const StockIssuancePersonal: React.FC = () => {
  ...
  const branchName = (user as any)?.branch_name || (user as any)?.branchName || 'your branch';

  const handleCheckBranchStock = async (item: any) => {
    ...
    try {
      ...
      console.error('Error checking branch stock:', err);
